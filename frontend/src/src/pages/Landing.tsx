    ...
    <div className="min-h-screen bg-bg-primary">
          ...
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-2.5">
              <div className="relative w-8 h-8 flex items-center justify-center">
                ...
                <span className="relative text-white font-bold text-sm font-[family-name:var(--font-display)]">
                  P
                </span>
              </div>
              <span className="text-lg font-bold text-text-primary tracking-tight font-[family-name:var(--font-display)]">
                PayGate
              </span>
            </Link>
            <div className="hidden md:flex items-center gap-1">
              <Link
                to="/docs"
                className="px-4 py-2 text-sm font-medium text-text-secondary hover:text-text-primary transition-colors rounded-lg hover:bg-black/[0.03]"
              >
                API Docs
              </Link>
              <Link
              ...
              <span className="px-4 py-2 text-sm font-medium text-text-muted/50 cursor-default">
                Changelog
              </span>
              <span className="px-4 py-2 text-sm font-medium text-text-muted/50 cursor-default">
                Status
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                to="/register" onClick={()=> checksession()}
            ...
            <div>
              ...
              <FadeIn delay={0.1}>
                <h1 className="text-4xl sm:text-5xl lg:text-[68px] font-bold text-text-primary tracking-[-0.04em] leading-[1.05] mb-6 font-[family-name:var(--font-display)]">
                  Route. Retry.
                  <br />
                  <span className="text-accent">Reconcile.</span>
                  <br />
              ...
              <FadeIn delay={0.2}>
                <p className="text-lg text-text-secondary max-w-lg mb-10 leading-relaxed">
                  PayGate sits between your app and your payment providers.
                  Intelligent routing, automatic failover, and a unified
                  dashboard — without rebuilding your stack.
                </p>
              </FadeIn>
              <FadeIn delay={0.3}>
                <div className="GetApiAccess" onClick={() =>   checksession()}>
                  <div className="flex flex-col sm:flex-row items-start gap-4 mb-10">
                    <Link
                      to="/register"
                      className="inline-flex items-center gap-2 px-8 py-4 bg-qaccent hover:bg-accent-hover text-white rounded-md font-semibold transition-all active:scale-[0.97] shadow-lg shadow-accent/20"
                    >
                      Get API Access
                    </Link>
                  </div>
              ...
              <div className="w-full max-w-md bg-surface border border-border rounded-[10px] p-8 relative shadow-xl shadow-black/[0.04]">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  {["Stripe", "Razorpay", "PayU", "Braintree"].map((p) => (
                    <div
                      key={p}
                      className="bg-bg-elevated border border-border rounded-md px-4 py-3 text-center text-xs font-semibold text-text-secondary hover:border-border-accent transition-colors"
                    >
                      {p}
                    </div>
                  ))}
      ...
      <section className="border-y border-accent/20 bg-accent-soft py-6 overflow-hidden relative">
        ...
        <div className="flex items-center gap-10">
          <span className="text-xs font-semibold tracking-wider uppercase text-accent whitespace-nowrap pl-6 shrink-0">
            Works with
          </span>
          <div className="overflow-hidden flex-1 relative">
            <div className="flex gap-14 animate-marquee whitespace-nowrap">
              {[...providers, ...providers, ...providers].map((name, i) => (
                <span
                  key={i}
                  className="text-base font-bold text-text-primary/40 hover:text-text-primary/80 transition-colors duration-300 cursor-default tracking-wide"
                >
                  {name}
                </span>
              ))}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {[
                ...
                <div key={label} className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold text-text-primary font-[family-name:var(--font-display)] tracking-tight">
                    {value}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <FadeIn>
            ...
            <p className="text-center text-text-secondary mt-3 mb-16 max-w-xl mx-auto">
              Whether you're shipping the integration or signing off the
              reports.
            </p>
          </FadeIn>
            ...
            <div>
              <FadeIn>
                <div className="flex items-center gap-2.5 mb-6">
                  ...
                  <span className="text-xs font-semibold tracking-wider uppercase text-info">
                    For Developers
                  </span>
                </div>
              </FadeIn>
              {[
                {
                  ...
                  desc: "One endpoint, all providers. No more juggling multiple SDKs and authentication flows.",
                },
                {
                  icon: Database,
                  title: "SDK for Node, Python, Go, PHP",
                  desc: "Official client libraries with full type support. Install in seconds, not hours.",
                },
                {
                  icon: Webhook,
                  title: "Webhook Inspector",
                  desc: "View, debug, and replay webhook events. Retry failed deliveries with one click.",
                },
                {
                  icon: Key,
                  title: "Live API Key Rotation",
                  desc: "Rotate keys without downtime. Zero-interruption key management for production.",
                },
              ...
              {[
                {
                  ...
                  desc: "Every transaction, every provider, one view. Filter, search, and drill into any payment.",
                },
                {
                  icon: RefreshCw,
                  title: "Multi-provider Reconciliation",
                  desc: "Automated reports across Stripe, Razorpay, PayU — no more spreadsheets.",
                },
                {
                  icon: Shield,
                  title: "Failure Rate Breakdown",
                  desc: "See exactly which providers are failing and why. Pinpoint issues before they cascade.",
                },
                {
                  icon: ArrowUpRight,
                  title: "Exportable Ledger",
                  desc: "Download CSV or PDF exports for any date range. Ready for audits and board meetings.",
                },
              ].map(({ icon: Icon, title, desc }, i) => (
                <FadeIn key={title} delay={i * 0.08}>
                  <div className="bg-surface border border-border rounded-[10px] p-6 mb-4 card-hover group">
          ...
          <FadeIn>
            <div className="text-center mt-12">
              <Link
                to="/features"
                className="inline-flex items-center gap-2 px-6 py-3 border border-border rounded-md text-sm font-semibold text-text-secondary hover:border-border-accent hover:text-text-primary transition-all"
              >
              ...
              visual: (
                <div className="grid grid-cols-2 gap-3">
                  {["Stripe", "Razorpay", "PayU", "Braintree"].map((p, i) => (
                    <div
                      key={p}
                      className="bg-surface border border-border rounded-lg px-4 py-3.5 flex items-center justify-between hover:border-accent/30 transition-colors"
                    >
                      <span className="text-sm font-semibold text-text-primary">
                        {p}
                      </span>
                      <div
                        className={`w-10 h-[22px] rounded-full relative cursor-pointer transition-colors ${i < 2 || i === 3 ? "bg-accent" : "bg-border"}`}
                      >
                        <div
                          className={`absolute w-4 h-4 rounded-full bg-white top-[3px] transition-transform ${i < 2 || i === 3 ? "translate-x-[18px]" : "translate-x-[3px]"}`}
                        />
                      </div>
                    </div>
                  ))}
                ...
                <div className="bg-surface border border-border rounded-[10px] p-5">
                  <div className="flex items-end gap-2 h-24 mb-4">
                    {[40, 65, 55, 80, 70, 90, 85].map((h, i) => (
                      <div
                        key={i}
                        className="flex-1 bg-accent rounded-t opacity-60 hover:opacity-100 transition-opacity"
                        style={{ height: `${h}%` }}
                      />
                    ))}
                  </div>
            ...
            >
              <FadeIn className={i % 2 === 1 ? "lg:order-2" : ""}>
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-xs font-bold text-accent/60 font-mono">
                    {num}
                  </span>
                  <span className="w-8 h-px bg-accent/30" />
                </div>
                <h3 className="text-2xl font-bold text-text-primary mb-3 font-[family-name:var(--font-display)]">
                  {title}
                </h3>
            ...
            <div className="bg-surface border border-border rounded-[10px] overflow-hidden grid lg:grid-cols-[200px_1fr] shadow-xl shadow-black/[0.03]">
              <nav className="border-r border-border p-5 hidden lg:block">
                {[
                  ...
                  <div
                    key={s}
                    className={`block px-3 py-2.5 rounded-md text-sm font-medium mb-1 ${i === 0 ? "text-accent bg-accent/5 border-l-2 border-accent" : "text-text-muted"}`}
                  >
                    {s}
                  </div>
                ))}
              ...
              <div className="p-8">
                ...
                <code className="text-xs font-mono text-accent mb-5 inline-block">
                  POST /v1/charges
                </code>
                <div className="code-block">
                  <pre className="p-5 text-sm font-mono text-text-secondary overflow-x-auto leading-relaxed">
      ...
      <section className="py-24 md:py-32 border-t border-border/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <FadeIn>
            ...
            <p className="text-center text-text-secondary mt-3 mb-16">
              Companies that moved to PayGate and never looked back.
            </p>
          </FadeIn>
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              {
                company: "FinStack",
                role: "Priya S., VP Engineering",
                quote:
                  "We were drowning in payment failures and manual retries. PayGate's retry engine handles most of it now — our support tickets dropped significantly.",
              },
              {
                company: "Kredify",
                role: "Arjun M., CTO",
                quote:
                  "Before PayGate, I spent every Monday pulling CSVs from three different dashboards. Now everything's in one place. My finance team is happy, and so am I.",
              },
              {
                company: "Movo",
                role: "Sarah L., Lead Developer",
                quote:
                  "Integrated Razorpay in a day, added Stripe the next. The unified API saved us weeks of plumbing work we'd been putting off for months.",
              },
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-16 items-start">
          <FadeIn>
            ...
            <p className="text-base text-text-secondary leading-relaxed mb-4">
              Get API access, talk to our team, or request a demo. We respond
              within 1 business day.
            </p>
            <p className="text-sm text-text-muted">
              No sales pressure. Just a conversation about your stack.
            </p>
          </FadeIn>
          <FadeIn delay={0.1}>
            <form
            ...
            >
              ...
              <div>
                ...
                <select
                  required
                  className="w-full px-4 py-2.5 bg-surface border border-border rounded-md text-sm text-text-primary focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 transition-all"
                >
              ...
              <div>
                ...
                <textarea
                  rows={3}
                  placeholder="Tell us about your payment stack..."
              ...
              <button
                type="submit"
                className="w-full py-3.5 bg-accent hover:bg-accent-hover text-white rounded-md font-semibold text-sm transition-all active:scale-[0.97]"
              >
                Request Access
              </button>
            </form>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <FadeIn>
            ...
            <p className="text-base text-text-secondary mb-8">
              PayGate doesn't add to it. It sits on top.
            </p>
            <Link
              to="/register"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
            {[
              ...
              <div key={title}>
                <h5 className="text-xs font-semibold text-text-primary uppercase tracking-wider mb-4">
                  {title}
                </h5>
                {links.map((l) => (
                  <Link
